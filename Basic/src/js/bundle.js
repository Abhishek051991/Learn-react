...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    key: "handleChange",
	    value: function handleChange(ele) {
	      var title = ele.target.value;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("input", { onChange: this.handleChange.bind(this), placeholder: this.props.title })
	      );
	    }
	  }]);
